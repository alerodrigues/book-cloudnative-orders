...
import com.example.cloudnative.domain.OrderService;
...
public class OrderFunctions {
	...
	@Bean
	public Consumer<Flux<OrderLabeledMessage>> dispatch(OrderService orderService) {
		return flux -> orderService.consumeOrderLabeledEvent(flux)
